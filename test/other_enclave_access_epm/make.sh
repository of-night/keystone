...
# eapp
riscv64-buildroot-linux-gnu-gcc -static -o ./test/other_enclave_access_epm/other_enclave_access_epm_eapp \
	./test/other_enclave_access_epm/eapp/other_enclave_access_epm_eapp.c \
...
# host
riscv64-buildroot-linux-gnu-g++ -o ./test/other_enclave_access_epm/other_enclave_access_epm_host \
	./test/other_enclave_access_epm/host/other_enclave_access_epm_host.cpp \
...
# eyrie-rt
cp build-starfive/visionfive264/buildroot.build/build/${EXAMPLES_DIR_NAME}/hello/eyrie-rt ./test/other_enclave_access_epm/

# loader.bin
cp build-starfive/visionfive264/buildroot.build/build/${EXAMPLES_DIR_NAME}/hello/loader.bin ./test/other_enclave_access_epm/
